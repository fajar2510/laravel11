  ...
  <x-slot:title>{{ $title }}</x-slot:title>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-0 lg:px-0">
        ...
        @foreach ($posts as $post )
          ...
          <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:-translate-y-1 transition-all duration-300 ease-in-out">
              ...
              <p class="mb-5 font-light text-gray-500 dark:text-gray-400 first-letter:font-bold first-letter:text-lg text-justify leading-relaxed">{{ Str::limit($post->body, 210) }}</p>
              <div class="flex justify-between items-center">
                <a href="/authors/{{ $post->author->username }}" class="hover:underline hover:text-blue-600 transition-all duration-300 ease-in-out">
                  <div class="flex items-center space-x-4">
                      ...
                      <span class="font-normal text-sm space-x-10 dark:text-white">
