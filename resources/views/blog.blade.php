    ...
    <div class="min-h-full">
            ...
            <div class="flex h-16 items-center justify-between">
              ...
              <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                 <!-- Button Notification if you using that ---->
        ...
        <main>
          <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <article>
                <h2>Post Title 1</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut nam magni repellendus dolor ipsum quos
                    consequuntur cupiditate modi, minus unde aliquam facilis qui! Beatae ex cum, ipsa expedita accusamus libero.
                </p>
            </article>
            <article>
                <h2>Post Title 2</h2>
