      ...
      <article class="mx-auto w-full max-w-5xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          <header class="mb-4 lg:mb-6 not-format">
            <a href="/posts" class="font-medium text-blue-600 text-xs hover:underline">&laquo; Back to all posts</a>
              ...
              <h1 class="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white text-left">{{ $post->title }}</h1>
          </header>
         
          <p class="first-letter:font-bold first-letter:text-2xl font-normal text-gray-500 dark:text-gray-400 text-justify leading-relaxed">
            {{ $post->body }}
          </p>
