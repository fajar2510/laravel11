                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    ...
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium {{ $page == $paginator->currentPage() ? 'bg-blue-500 text-white' : 'bg-white text-gray-700' }} border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600">
                                            {{ $page }}
                                        </span>
                                    </span>
                                @else
